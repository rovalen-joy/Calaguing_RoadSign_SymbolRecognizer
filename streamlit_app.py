...
def app():
    ...
    st.title('Road Sign Symbol Classification')
    st.subheader('by Rovalen Joy Calaguing, BSCS 3A AI, WVSU College of ICT')
    
    st.write('Dataset description: This dataset is designed for training and testing machine learning models for road sign recognition, specifically targeting four types of road signs: Parking, No Stopping, No Entry, and T Intersection')
